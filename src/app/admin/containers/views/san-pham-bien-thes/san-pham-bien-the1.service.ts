...
export class SanPhamBienThe1Service extends BaseDefaultService { 
  constructor(http: HttpClient, injector: Injector) {
    super(http, injector, `${environment.URL_API1}/SanPhamBienThes`);
  }
  ...
  Save(d: any): Observable<any> {
    return this._http.post<any>(`${environment.URL_API1}/SanPhamBienThes`, d)
  } 
