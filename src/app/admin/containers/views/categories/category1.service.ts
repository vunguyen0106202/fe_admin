...
export class Category1Service extends BaseDefaultService { 
  constructor(http: HttpClient, injector: Injector) {
    super(http, injector, `${environment.URL_API1}/Loais`);
}
  ...
  Save(category: any): Observable<any> {
    return this._http.post<any>(`${environment.URL_API1}/Loais`, category)
  }
