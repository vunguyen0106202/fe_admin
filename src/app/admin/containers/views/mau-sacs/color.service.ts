...
export class ColorService extends BaseDefaultService { 
  constructor(http: HttpClient, injector: Injector) {
    super(http, injector, `${environment.URL_API1}/MauSacs`);
  }
  ...
  Save(d: any): Observable<any> {
    return this._http.post<any>(`${environment.URL_API1}/MauSacs`, d)
  }

  GetColorFollowCategory() {
    const queryString = `${this.serviceUri}/GetColorFollowCategory`;
    return this.defaultGet(queryString);
  }
